...
class TimerTab:
    def __init__(self, parent):
        ...
        # Interfaz Gráfica
        instruction = tk.Label(self.frame, text="Enter minutes to countdown:", font=("Arial", 12))
    ...
    def start(self):
        # Lee los minutos y los convierte a segundos
        try:
    ...
    def update_logic(self):
        # Lógica de cuenta regresiva controlada por tiempo real
        if self.running:
